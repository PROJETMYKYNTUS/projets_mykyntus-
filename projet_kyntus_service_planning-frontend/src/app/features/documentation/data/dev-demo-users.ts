...
/** Triplet organisationnel alignÃ© sur le seed SQL (Casa â€” ventes terrain) â€” repli typage uniquement. */
const DEMO_ORG = {
...
/** ConservÃ© pour compatibilitÃ© ; le sÃ©lecteur dev sâ€™appuie sur lâ€™API (plus de fusion dans lâ€™UI). */
