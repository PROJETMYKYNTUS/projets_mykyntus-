    ...
    PrimeValidationWorkflowRuntime wfRuntime)
{
        ...
        CancellationToken ct)
    {
        ...
        if (existing is null)
        {
            fiche = new EmployeePrimeServiceFicheEntity
            {
                Id = Guid.NewGuid(),
    ...
    private async Task<SupervisorCellulePrimeDraftEntity> EnsureImportDraftAsync(
        string sup,
        string rootPoleId,
        string celluleId,
        string period,
        ...
        CancellationToken ct)
    {
        ...
        draft = new SupervisorCellulePrimeDraftEntity
        {
            Id = Guid.NewGuid(),
            SupervisorUserId = sup,
            RootPoleId = rootPoleId,
    ...
    private static void PrepareFicheForImportReplace(EmployeePrimeServiceFicheEntity fiche)
    {
