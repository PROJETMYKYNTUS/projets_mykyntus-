...
export class HrManagementPageComponent implements OnInit, OnDestroy {
  ...
  /** Ligne en cours dâ€™action workflow (internalId). */
  busyWorkflowId: string | null = null;
  /** Ligne en cours de gÃ©nÃ©ration PDF. */
  ...
  /** Recharge la file aprÃ¨s action mÃ©tier (PUT workflow). */
  ...
  /** Vue RH: toutes les demandes non encore matÃ©rialisÃ©es en document gÃ©nÃ©rÃ©. */
  ...
  private formatHttpError(e: unknown): string {
    return formatDocumentationUxMessage(
      e,
      'Lâ€™action nâ€™a pas pu etre finalisee pour le moment. Merci de reessayer.',
    );
  }
}
