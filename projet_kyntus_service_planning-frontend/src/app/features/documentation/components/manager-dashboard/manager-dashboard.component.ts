...
export class ManagerDashboardComponent implements OnInit, OnDestroy {
  ...
  readonly statsDef = [
    { key: 'req', label: 'Demandes Ã©quipe', icon: 'users', color: 'text-blue-500', bg: 'bg-blue-500/10' },
    { key: 'pend', label: 'En attente de validation', icon: 'clock', color: 'text-amber-500', bg: 'bg-amber-500/10' },
    { key: 'gen', label: 'Documents gÃ©nÃ©rÃ©s (Ã©quipe)', icon: 'check-circle-2', color: 'text-emerald-500', bg: 'bg-emerald-500/10' },
    { key: 'mem', label: 'Membres de lâ€™Ã©quipe', icon: 'user', color: 'text-indigo-500', bg: 'bg-indigo-500/10' },
  ];
