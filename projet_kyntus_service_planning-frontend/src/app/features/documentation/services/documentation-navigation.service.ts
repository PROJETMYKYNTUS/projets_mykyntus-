...
export class DocumentationNavigationService {
  ...
  /** false = sidebar dÃ©veloppÃ©e (largeur 16rem), true = mode icÃ´nes uniquement */
  ...
  /** Met Ã  jour le rÃ´le sans rÃ©initialiser lâ€™onglet (ex. alignement aprÃ¨s GET /users/me). */
