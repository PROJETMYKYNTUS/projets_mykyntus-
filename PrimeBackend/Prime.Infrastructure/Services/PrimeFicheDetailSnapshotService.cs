...
public static class PrimeFicheDetailSnapshotService
{
    ...
    public static bool IsFrozen(EmployeePrimeServiceFiche fiche) =>
    ...
    public static void FreezeExistingSnapshot(EmployeePrimeServiceFiche fiche, DateTimeOffset now)
    {
