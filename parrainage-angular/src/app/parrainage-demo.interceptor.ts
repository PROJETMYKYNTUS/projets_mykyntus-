...
import { isParrainageDemoMockEnabled } from './parrainage/mock-data/parrainage-demo-config';
import { isParrainageDemoEmptyPayload, resolveParrainageDemoGet } from './parrainage/mock-data/parrainage-demo-resolver';
