...
export class AdminPermissionsPageComponent implements OnInit {
  ...
  async onSave(): Promise<void> {
    ...
    try {
      ...
      this.successMessage = 'Permissions sauvegardÃ©es pour les rÃ¨gles affichÃ©es.';
    } catch {
      this.errorMessage = 'Ã‰chec de sauvegarde cÃ´tÃ© serveur.';
    } finally {
      this.saving = false;
    }
  }
  ...
  filterSummaryDept(): string {
    return this.selectedDepartment === 'ALL' ? 'Tous les dÃ©partements' : this.selectedDepartment;
  }
}