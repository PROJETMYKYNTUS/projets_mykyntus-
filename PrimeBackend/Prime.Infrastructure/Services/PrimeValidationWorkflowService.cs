...
/// d'une <see cref="EmployeePrimeServiceFiche"/> (Phase 1.1).
///
...
public static class PrimeValidationWorkflowService
{
    ...
    public static void ApproveOrThrow(EmployeePrimeServiceFiche fiche, string approverUserId, string approverRole, DateTimeOffset now)
    {
    ...
    public static void ApplyApproval(EmployeePrimeServiceFiche fiche, string nextStatus, string approverUserId, DateTimeOffset now)
    {
    ...
    public static void RejectOrThrow(EmployeePrimeServiceFiche fiche, string rejecterUserId, string rejecterRole, string reason, DateTimeOffset now)
    {
    ...
    public static void ApplyReject(EmployeePrimeServiceFiche fiche, string rejecterUserId, string reason, DateTimeOffset now)
    {
